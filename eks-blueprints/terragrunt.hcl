...
dependency "eks_cluster" {
  ...
  mock_outputs = {
    ...
    ebs_csi_driver_irsa_role_arn = "dummy_ebs_csi_driver_irsa_role_arn"
  }
}
...
inputs = {
  ...
  ebs_csi_driver_irsa_role_arn = dependency.eks_cluster.outputs.ebs_csi_driver_irsa_role_arn
